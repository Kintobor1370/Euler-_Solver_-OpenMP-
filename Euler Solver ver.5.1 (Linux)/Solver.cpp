...
private:
    ...
    {
        if (std::abs(values[0].last() - asymptotic_value) < 1e-08)
...
private:
    ...
    // Launch Visualiser.py     !! THIS FUNCTION WORKS ONLY ON LINUX !!
...
public:
    ...
    void KernelTest()
    {
        ...
        Function Kernel_function(Props.KernelsGrid, kernel);
        cout << "MAX NON-ZERO NUMBERS: " << Props.MaxNumForW << '\n';
        //cout << "MAX NON-ZERO NUMBERS: " << Props.MaxNumForM << '\n';
        FileWriter VisData(visdata_path);
        VisData.WritePlotData("14.4", "Kernel test", "x", "distribution", Kernel_function.X(), Kernel_function.Y());
        Visualise_Linux();
    }
};
...
**                                                        MAIN BODY                                                      **
***************************************************************************************************************************
**                          Please uncomment the experiment of your choice from options below                            **
**************************************************************************************************************************/
int main()
{
    Experiments Run;
    ...
    //Run.Custom_Experiment();                        // Your custom experiment 
    // IMPORTANT!!
    // To conduct your custom experiment, please navigate to 'Data/Custom' folder and fill the 'experiment.txt' file according to the example.
