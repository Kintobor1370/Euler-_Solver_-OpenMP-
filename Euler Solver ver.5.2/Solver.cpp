...
int main()
{
    ...
    string custom_experiment_tip = "Please navigate to \'Data\\Custom\' folder and fill the \'experiment.csv\' file according to the example.\nPress ENTER to confirm and start the experiment\nPress ESC to quit\n";
    string commands[] =
    {
        "  > 14.4.a\n    14.4.b\n    14.4.c\n    14.6.a\n    14.6.b\n    Custom experiment\n",
        "    14.4.a\n  > 14.4.b\n    14.4.c\n    14.6.a\n    14.6.b\n    Custom experiment\n",
    ...
    system("cls");
    cout << greetings + commands[current_index] + tip;
    char input = getch();
